...
*/
        ...
        exploitationList.add(ProjectExploitation.builder().advanceSite("12").unitName("asdsawqeeqweqwewqwewqewqeEDWSWSWSWSWSWSWSWSWSWSFERW QWEDDWQ3EDRFEWfreckle非财务部规划 二刀肉访问发热体无4而发愁软文二锅头否4如染发给他房3让我给他发34 34温柔风 3丰田果 34儿童房个人43恶女个").build());
        ...
        list.add(ProjectPipelineRelocation.builder().designModification(1).unitName("asdsawqeeqweqwewqwewqewqe").designModificationComplete(3).build());
        list.add(ProjectPipelineRelocation.builder().designModification(2).unitName("哈哈哈").designModificationComplete(4).build());
